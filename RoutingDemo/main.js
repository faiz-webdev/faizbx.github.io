...
module.exports = "<div class=\"blog-post\" *ngFor=\"let post of posts\">\n  <h6 class=\"blog-post-title\"><a [routerLink]=\"[post.id]\">{{ post.title }}</a></h6>\n  <p>{{ post.body }}</p>\n  <hr>\n</div>\n"
...
module.exports = __webpack_require__(/*! D:\angular course\angular7cli\RoutingDemo\src\main.ts */"./src/main.ts");
